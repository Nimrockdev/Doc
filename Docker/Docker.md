...
Jest para Node.js: Javier Sánchez Gómez
Etiquetas: Guías y procesos

Este documento ha sido creado a partir de:

[https://github.dev/Nimrockdev/Doc/blob/master/Docker/Docker.md](https://github.dev/Nimrockdev/Doc/blob/master/Docker/Docker.md)
...
`docker pull mysqldocker pull mongo`
...
`docker build --tag apache-centos -f  DockerFile .docker build --tag apache-centos:apache -f  DockerFile .`
...
`sudo curl -L "[https://github.com/docker/compose/releases/download/1.25.3/docker-compose-$](https://github.com/docker/compose/releases/download/1.25.3/docker-compose-$)(uname -s)-$(uname -m)" -o /usr/local/bin/docker-compose
